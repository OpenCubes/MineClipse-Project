...
public class Snippet047WizardWithLongRunningOperation {
	...
	private static class MyWizard extends Wizard {
		...
		public MyWizard(final int loadingType) {
	...
	private static class MyWizardPage extends WizardPage {
		...
		protected MyWizardPage(final String pageName) {
			super(pageName);
			setTitle(pageName);
		}
	...
	private static class MyWizardPageThread extends WizardPage {
		...
		protected MyWizardPageThread(final String pageName,
	...
	private static class MyModel {
		...
		public MyModel(final int index) {
			this.index = index;
		}

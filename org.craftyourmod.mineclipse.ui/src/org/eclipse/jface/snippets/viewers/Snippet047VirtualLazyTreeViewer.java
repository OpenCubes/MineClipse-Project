...
public class Snippet047VirtualLazyTreeViewer {
	private class MyContentProvider implements ILazyTreeContentProvider {
		...
		public MyContentProvider(final TreeViewer viewer) {
			this.viewer = viewer;
		}
	...
	public class LeafNode {
		...
		public LeafNode(final int counter, final IntermediateNode parent) {
	...
	public class IntermediateNode {
		...
		public IntermediateNode(final int counter) {
			this.counter = counter;
		}
		...
		public void generateChildren(final int i) {
	...
	public Snippet047VirtualLazyTreeViewer(final Shell shell) {
